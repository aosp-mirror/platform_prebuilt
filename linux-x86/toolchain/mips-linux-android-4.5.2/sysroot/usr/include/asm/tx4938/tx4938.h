...
#ifdef __BIG_ENDIAN
#define endian_def_l2(e1, e2)   volatile unsigned long e1, e2
#define endian_def_s2(e1, e2)   volatile unsigned short e1, e2
#define endian_def_sb2(e1, e2, e3)   volatile unsigned short e1;volatile unsigned char e2, e3
#define endian_def_b2s(e1, e2, e3)   volatile unsigned char e1, e2;volatile unsigned short e3
#define endian_def_b4(e1, e2, e3, e4)   volatile unsigned char e1, e2, e3, e4
#else
#define endian_def_l2(e1, e2)   volatile unsigned long e2, e1
...
struct tx4938_pcic_reg {
 ...
 volatile unsigned long p2gm0plbase;
 ...
 volatile unsigned long g2ptocnt;
 ...
 volatile unsigned long unused7[12];
 volatile unsigned long long pdmca;
 volatile unsigned long long pdmga;
 volatile unsigned long long pdmpa;
 volatile unsigned long long pdmctr;
 volatile unsigned long long pdmcfg;
...
#define TX4938_EBUSC_SIZE(ch)   (0x00100000 << ((unsigned long)(tx4938_ebuscptr->cr[ch] >> 8) & 0xf))
