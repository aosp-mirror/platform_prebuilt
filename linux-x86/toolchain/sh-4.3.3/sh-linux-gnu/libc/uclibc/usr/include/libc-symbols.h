...
#ifdef __UCLIBC_ASM_SET_DIRECTIVE__
#define ASM_SET_DIRECTIVE __UCLIBC_ASM_SET_DIRECTIVE__
#else
#define ASM_SET_DIRECTIVE .set
#endif
...
#   define strong_alias(original, alias)				\
  ...
  ASM_SET_DIRECTIVE C_SYMBOL_NAME (alias),C_SYMBOL_NAME (original) ASM_LINE_SEP	\
  ASM_GLOBAL_DIRECTIVE C_SYMBOL_DOT_NAME (alias) ASM_LINE_SEP		\
  ASM_SET_DIRECTIVE C_SYMBOL_DOT_NAME (alias),C_SYMBOL_DOT_NAME (original)
#   define strong_data_alias(original, alias)				\
  ASM_GLOBAL_DIRECTIVE C_SYMBOL_NAME (alias) ASM_LINE_SEP		\
  ASM_SET_DIRECTIVE C_SYMBOL_NAME (alias),C_SYMBOL_NAME (original)
#  else
#   define strong_alias(original, alias)				\
  ASM_GLOBAL_DIRECTIVE C_SYMBOL_NAME (alias) ASM_LINE_SEP		\
  ASM_SET_DIRECTIVE C_SYMBOL_NAME (alias),C_SYMBOL_NAME (original)
